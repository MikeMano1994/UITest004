...
package com.forwards.android.uitest004.common.data;
...
public class ExampleExpandableDataProvider extends AbstractExpandableDataProvider {
    ...
    public ExampleExpandableDataProvider() {
        final String groupItems[]  = {"매주 해 주세요~~~", "한번만 해 주세요~~~"};
        final String childItems[][] = {{"설거지", "분리 수거", "청소기 돌리기"},
                {"대청소의 날!!!", "여름 준비하기"}};
        ...
        for (int i = 0; i < groupItems.length; i++) {
            ...
            for (int j = 0; j < childItems[i].length; j++) {
                ...
                final String childText = childItems[i][j];
