...
package com.forwards.android.uitest004;
...
import com.forwards.android.uitest004.common.data.AbstractExpandableDataProvider;
...
public class ExpandableDraggableSwipeableExampleFragment extends Fragment
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerViewDragDropManager.setDraggingItemShadowDrawable(
                (NinePatchDrawable) ContextCompat.getDrawable(getContext(), R.drawable.material_shadow_z3_mdpi));
        ...
        if (supportsViewElevation()) {
            ...
            mRecyclerView.addItemDecoration(new ItemShadowDecorator((NinePatchDrawable) ContextCompat.getDrawable(getContext(), R.drawable.material_shadow_z1_mdpi)));
        }
